...
export type UserFragmentFragment = { __typename?: "user" } & Pick<
  ...
  | "username"
> & {
    tasks: Array<{ __typename?: "task" } & Pick<Task, "id">>;
    employee?: Maybe<
...
export type ListAllUsersQueryVariables = Exact<{ [key: string]: never }>;

export type ListAllUsersQuery = { __typename?: "query_root" } & {
  user: Array<
    { __typename?: "user" } & Pick<User, "id" | "lastName" | "firstName">
  >;
};

export type WatchOneUserSubscriptionVariables = Exact<{
  id: Scalars["uuid"];
}>;

export type WatchOneUserSubscription = { __typename?: "subscription_root" } & {
  user: Array<{ __typename?: "user" } & Pick<User, "id">>;
};

export const UserFragmentFragmentDoc: DocumentNode<
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "preferredComponentLayout" },
            arguments: [],
            directives: []
          },
          {
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "thirdPartyId" },
            arguments: [],
            directives: []
          },
          {
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "totalWorkHours" },
                  arguments: [],
                  directives: []
                },
                {
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "employeeLevel" },
                  arguments: [],
                  directives: []
                },
                {
...
export const ListAllUsersDocument: DocumentNode<
  ListAllUsersQuery,
  ListAllUsersQueryVariables
> = {
  kind: "Document",
  definitions: [
    {
...
export const WatchOneUserDocument: DocumentNode<
  WatchOneUserSubscription,
  WatchOneUserSubscriptionVariables
> = {
  kind: "Document",
  definitions: [
    {
      ...
      name: { kind: "Name", value: "watchOneUser" },
      variableDefinitions: [
        {
